...
public class LogUtils {
  ...
  public static final String LOG_DIR = "log";
	...
	public static void trace(Object... messages) { getCallerLogger().trace(buildMessage(messages)); }
	public static void debug(Object... messages) { getCallerLogger().debug(buildMessage(messages)); }
	public static void info(Object... messages)  { getCallerLogger().info(buildMessage(messages)); }
	public static void warn(Object... messages)  { getCallerLogger().warn(buildMessage(messages)); }
	public static void error(Object... messages) { getCallerLogger().error(buildMessage(messages)); }
	public static void fatal(Object... messages) { getCallerLogger().fatal(buildMessage(messages)); }
	...
	public static <T> T logMethodTimeWithIOException(int level, CodeReturnRunnerWithIOException<T> mt)
      throws IOException {
    Timer t = new Timer();
    T result = mt.run();
	  logMethodTime(t, level);
