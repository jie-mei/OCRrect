             ...
             ContextSensitiveBenchmarkSuggestMixin
{
   ...
   * replaced by "{@value RELAX_WORD_SUB}" and one word replaced by "{@value
   * MATCH_WORD_SUB}".
   * 
   * @param  ngram  a list of {@code n} gram strings.
   * @param  index  the index of the pivot (matching) gram in n-gram.
   * @return a concatenated skip-ngram, which pivot gram is skipped and another
   *    gram is substituted by "{@value RELAX_WORD_SUB}".
   */
